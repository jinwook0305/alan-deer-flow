...
class Paths:
    ...
    def user_skills_dir(self, user_id: str) -> Path:
        """Per-user root for that user's skills: `{base_dir}/users/{user_id}/skills/`."""
    ...
    def user_custom_skills_dir(self, user_id: str) -> Path:
        ...
        Public skills remain globally shared at the configured skills root; only
        the ``custom/`` subtree is isolated per-user.
        """
